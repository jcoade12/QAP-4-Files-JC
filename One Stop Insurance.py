...
print(f"            Policy information processed and saved.")
print()
print("_____________________________________________________________")


f=open('policies.dat')
f.write(Next_policy_num,",",inv_date,",",customer_first,customer_last,",",adress,",",city,",",province,",",postal_code,",",phone_numb,",",payment_choice,",",numbers_of_cars_being_insured,",",lonercar,",",glass_cov,",",total_cost)

f=open('OSICDEF.dat')
f.write(Next_policy_num+1)
